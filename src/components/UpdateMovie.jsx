...
function Update(){
    ...
    const getNowMovie = (id) => {
        id = id_pel;
        axios.get(`https://back-chanona-8ec460b20f77.herokuapp.com/readOneMovie/${id}`)
        .then((res) => {
    ...
    const updateMovie = async (id) => {
        ...
        await fetch(`https://back-chanona-8ec460b20f77.herokuapp.com/update/${id}`,
            {
                method: 'POST',
                body: formdata,
            })
    ...
    const getCategories = async () => {
        axios.get("https://back-chanona-8ec460b20f77.herokuapp.com/getCategories").then((response) => {
